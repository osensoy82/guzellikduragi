    ...
    <div className="space-y-6 animate-in slide-in-from-top-4 duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Güzellik merkezinizde sunulan profesyonel işlemler.</p>
        </div>
        ...
        {services.map((service) => (
          <Card key={service.id} className="group hover:shadow-lg transition-all border-none shadow-sm overflow-hidden bg-card">
            ...
            <CardHeader>
              ...
              <CardDescription>Profesyonel uygulama ve seans takibi.</CardDescription>
            </CardHeader>
            <CardContent>

    ...
    <div className="space-y-6 animate-in slide-in-from-bottom-2 duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Müşteri portföyünüzü izleyin ve düzenleyin.</p>
        </div>
            ...
            <Table>
              <TableHeader className="bg-muted/50">
                <TableRow>
                  ...
                  <TableHead>Borç Durumu</TableHead>
              ...
              <TableBody>
                {filteredCustomers.map((customer) => (
                  <TableRow key={customer.id} className="hover:bg-accent/50 transition-colors">
                    ...
                    <TableCell className="font-semibold text-primary">{customer.totalSpend}</TableCell>
                    <TableCell>
                      {customer.debt !== "₺0" ? (
                        ...
                        <Badge variant="secondary" className="text-emerald-600 bg-emerald-50">Ödendi</Badge>
                      )}
                    </TableCell>
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-48">
                          <DropdownMenuLabel>Müşteri Kartı</DropdownMenuLabel>
                          <DropdownMenuSeparator />
